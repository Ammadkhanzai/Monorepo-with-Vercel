...
const Home = () => {
  ...
  useEffect(()  => {
    ...
    axios.get('http://localhost:5000/api/category', { cancelToken: cancelTokenSource.token })
      .then(response => {
  ...
  useEffect(()  => {
    ...
    const fetchSoftware = async (id , title)=>{
      await axios.get(`http://localhost:5000/api/software-management/${id}/${5}`, { cancelToken: cancelTokenSource.token })
      .then(response => {
  ...
  useEffect(()=>{
    const cancelTokenSource = axios.CancelToken.source()
    axios.get(`http://localhost:5000/api/popular-software/5`, { cancelToken: cancelTokenSource.token })
    .then(response => {
      // console.log(response);  
  ...
  useEffect(()=>{
    const cancelTokenSource = axios.CancelToken.source()
    axios.get(`http://localhost:5000/api/latest-software/5`, { cancelToken: cancelTokenSource.token })
    .then(response => {
      // console.log(response);  
